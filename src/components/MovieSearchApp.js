...
//https://api.themoviedb.org/3/movie/550?api_key=ad8e609b80cf398696e4720d6b7bf4a1
// https://api.themoviedb.org/3/search/movie?api_key=ad8e609b80cf398696e4720d6b7bf4a1&query=''
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await axios.get(
        `https://api.themoviedb.org/3/search/movie?api_key=ad8e609b80cf398696e4720d6b7bf4a1&query='${queryDebounce}'`
      );
  ...
  return (
    <div className="p-10 ">
      <div className="w-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
          className="w-full p-5 rounded-lg border outline-none border-blue-500 shadow-[0px_0px_0px_3px_rgba(125,_106,_255,_0.2)]"
      ...
      <div className="p-7 flex flex-1 flex-col">
        ...
        <svg
          ...
          <span className="text-sm font-semibold text-[#333]">
            <LoadingSkeleton width="20px" height="16px"></LoadingSkeleton>
          </span>
        </div>
      </div>
    </div>
