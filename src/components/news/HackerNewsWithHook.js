...
import useHackerFetchAPI from "../../hooks/useHackeFetchAPI";
// import lodash from "lodash";

// https://hn.algolia.com/api/v1/search?query=react
const HackerNews = () => {
  const [query, setQuery] = useState("");
  const {data, loading, errorMessage, setUrl} = useHackerFetchAPI(`https://hn.algolia.com/api/v1/search?query=`, {hits: []});
